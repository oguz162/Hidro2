...
module.exports = {
    ...
    SESSION: process.env.SPEKTRAL_CODE === undefined ? '' : process.env.SPEKTRAL_CODE,
    ANTİLİNK: process.env.ANTİ_LİNK === undefined ? 'false' : process.env.ANTİ_LİNK,
    AUTOBİO: process.env.AUTO_BİO === undefined ? 'false' : process.env.AUTO_BİO,
    FAKE: process.env.FAKE_REMOVE === undefined ? 'false' : process.env.FAKE_REMOVE,
    GANSTYLE: process.env.GAN_IMAGE === undefined ? 'https://resimyukle.io/r/TPNSKHSIwz' : process.env.GAN_IMAGE,
    ...
    PHONE: process.env.NUMBER === undefined ? '+905516491871' : process.env.NUMBER,   
    OA_NAME: process.env.DEPLOYER === undefined ? 'Zlose' : process.env.DEPLOYER,
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By Zlose' : process.env.ALL_CAPTION,
    LG_LOGO: process.env.LG_LOGO === undefined ? 'https://resimyukle.io/r/TPNSKHSIwz' : process.env.LG_LOGO,
    LOGO_NAME: process.env.LOGO_NAME === undefined ? 'Spektral' : process.env.LOGO_NAME,
    CODE: process.env.C_CODE === undefined ? '90' : process.env.C_CODE,
    MENTION: process.env.TAG_REPLY === undefined ? '905516491871@s.whatsapp.net' : process.env.TAG_REPLY,
    ADDMSG: process.env.ADD_MESSAGE === undefined ? 'default' : process.env.ADD_MESSAGE,
    PLKS: process.env.THERI_LIST === undefined ? false : process.env.THERI_LIST,
    AFPLK: process.env.BOT_SIFRE === undefined ? false : process.env.BOT_SİFRE,
    ...
    BOT: process.env.BOT_NAME === undefined ? '༺═══❃spektral❃═══༻' : process.env.BOT_NAME,
    KAZTRO_SER: process.env.ALIVE_BUTTON === undefined ? 'Şuan/Mutlu' : process.env.ALIVE_BUTTON,   
    ...
    YAK: process.env.YAK === undefined ? '905516491871,0' : process.env.YAK,
    BRANCH: 'master',
    HEROKU: {
